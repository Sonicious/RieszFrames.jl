...
S. Held, M. Storath, P. Massopust and B. Forster, "Steerable Wavelet Frames Based on the Riesz Transform" doi: [10.1109/TIP.2009.2036713](https://dx.doi.org/10.1109/TIP.2009.2036713)
"""
function Held(x, m=4)
...
function q(x, m)
    ...
    elseif m == 3
        return @. -13 * 4 + 140 * 4^2 * x - 630 * 4^3 * x .^ 2 + 1540 * 4^4 * x .^ 3 - 2205 * 4^5 * x .^ 4 + 1848 * 4^6 * x .^ 5 - 840 * 4^7 * x .^ 6 + 160 * 4^8 * x .^ 7
    elseif m == 4
